                          ...
                          {#if i > 0}
                            {#if i === currentDay && selectedMonth === currentMonth && selectedYear === currentYear}
                              <button
                                ...
                                class="rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-700 focus:bg-purple-500 hover:bg-purple-500 text-base w-8 h-8 flex items-center justify-center font-medium text-white bg-purple-700"
                                >{i}</button
                              >
                            {:else}
